    ...
    schedule: { 
      ...
      events: [
        ...
        },
        {
          day: "Segunda-feira",
          schedule: [
            { time: "18:30h", title: "Ensaio do Grupo de Mulheres" }
          ]
        },
        {
          day: "Terça-feira",
          schedule: [
            { time: "19:30h", title: "Culto de Oração" }
          ]
        },
        {
          day: "Quarta-feira",
          schedule: [
            { time: "19:00h", title: "Círculo de Oração das Mulheres" }
          ]
        },
        {
          day: "Quinta-feira",
        ...
        },
        {
          day: "Sábado",
          schedule: [
            { time: "19:00h", title: "Monte com os Homens" }
          ]
        }
      ]
    },
      ...
      events: [
        {
          day: "Sunday",
          schedule: [
            { time: "19:00h", title: "Praise & Worship Service" }
          ]
        },
        {
          day: "Monday",
          schedule: [
            { time: "18:30h", title: "Women's Group Rehearsal" }
          ]
        },
        {
          day: "Tuesday",
          schedule: [
            { time: "19:30h", title: "Prayer Service" }
          ]
        },
        {
          day: "Wednesday",
          schedule: [
            { time: "19:00h", title: "Women's Prayer Circle" }
          ]
        },
        {
          day: "Thursday",
          schedule: [
            { time: "19:00h", title: "Bible Study" }
          ]
        },
        {
          day: "Saturday",
          schedule: [
            { time: "19:00h", title: "Men's Mountain Prayer" }
          ]
        }
      ]
    },
      ...
      events: [
        {
          day: "Domingo",
          schedule: [
            { time: "19:00h", title: "Culto de Alabanza y Adoración" }
          ]
        },
        {
          day: "Lunes",
          schedule: [
            { time: "18:30h", title: "Ensayo del Grupo de Mujeres" }
          ]
        },
        {
          day: "Martes",
          schedule: [
            { time: "19:30h", title: "Culto de Oración" }
          ]
        },
        {
          day: "Miércoles",
          schedule: [
            { time: "19:00h", title: "Círculo de Oración de Mujeres" }
          ]
        },
        {
          day: "Jueves",
          schedule: [
            { time: "19:00h", title: "Estudio Bíblico" }
          ]
        },
        {
          day: "Sábado",
          schedule: [
            { time: "19:00h", title: "Monte con los Hombres" }
          ]
        }
      ]
    },
